...
# Initialize Settings for LlamaIndex (used for embeddings/retrieval)
...
# Use a specific variable for the alert model to avoid confusion
ALERT_MODEL = "phi3:mini"
...
async def generate_alert(
    ...
    # ── Call Ollama directly to avoid LlamaIndex overhead/config issues ──
    try:
        ...
        # Fallback to a simpler message if LLM fails
        return "Your body signals show some unusual activity. Please check your dashboard for details."
