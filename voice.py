    ...
    def test_voices(self):
        ...
        for onnx_path in _REPO_DIR.rglob("*.onnx"):
            with self.subTest(onnx_path=onnx_path):
                ...
                # Note: Adapt directory structure checks if needed based on actual project layout
                pass
...
def run_tests() -> None:
    ...
    if result.failures or result.errors:
        print("Test failures or errors occurred.")
    ...
    for onnx_path in sorted(_REPO_DIR.rglob("*.onnx")):
        ...
        voices[voice_key] = {
            ...
            "files": {
                ...
                for file_path in [onnx_path, config_path] if file_path.exists()
            },
